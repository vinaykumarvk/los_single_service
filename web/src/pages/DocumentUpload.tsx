...
import { Upload, Download, CheckCircle, Clock, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
      ...
      <div>
        ...
        {applicationId && (
          <p className="text-sm sm:text-base text-secondary-600 dark:text-secondary-400 mt-1">Application ID: {applicationId}</p>
        )}
      </div>
